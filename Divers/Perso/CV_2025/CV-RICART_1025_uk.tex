...
\leftheader{%
  ...
  \bigskip
    ...
    {\LARGE\bfseries\sffamily Mathematics and Computer Science Teacher}

  \medskip

  {\small
  \makefield{\faEnvelope[regular]}{\href{mailto:Thomas.Ricart@ac-toulouse.fr}{\texttt{Thomas.Ricart@ac-toulouse.fr}}}
      \makefield{\faPhone}{+33611342849}
\makefield{\faGithub}{\href{https://thomasricart.github.io/}{\texttt{https://thomasricart.github.io/}}}}
...
\makerubric{employment_uk}
\makerubric{education_uk}
...
%\input{publications}
\newpage
\makerubric{experiences_uk}


\makerubric{peda_uk}
\makerubric{academique_uk}

\makerubric{skills_uk}
\makerubric{langues_uk}
