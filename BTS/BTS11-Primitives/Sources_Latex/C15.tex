...
\begin{example}{Recherche de primitive}{}
...
\renewcommand{\arraystretch}{2.2} % Espacement vertical important pour le confort visuel
...
\begin{propriete}{Primitives usuelles}{}
    ...
    \includegraphics[width = 0.49\linewidth]{img_3370.jpg}\hfill{}
    \includegraphics[width = 0.49\linewidth]{PB_Bac_06468_MathT_gene_p211-230_C09_Tab_4.png}
\end{propriete}
...
\begin{methode}{Recherche de toutes les primitives}{}

    Pour trouver toutes les primitives de $f$, il suffit:

    \begin{enumerate}
        \item de trouver UNE primitive de $f$ et la noter $F$
        \item d'ajouter une constante $k\in\R$ pour trouver TOUTES les primitives de $f$ et la noter $G$.
    \end{enumerate}
\end{methode}
...
\begin{methode}{Déterminer LA primitive vérifiant une condition}{}
    ...
    \item Déterminer la valeur de la constante de manière à ce que $G(a)=F(a)+k=b$
...
\begin{exercice}{Exercice d'application}{}
    ...
    Déterminer la primitive $H$ de $f$ qui est telle que $G(0)=4$.
